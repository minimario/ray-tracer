TARGETS := src/tuple.byte \
		   ...
		   src/shapeType.byte \
		   src/patterns.byte \
		   src/patternType.byte \
		   src/testPattern.byte \
		   src/stripePattern.byte \
		   src/gradientPattern.byte \
		   src/checkersPattern.byte \
		   src/ringPattern.byte \
		   src/util.byte
